                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="keterangan" id="keterangan" placeholder="Keterangan"
                                    class="form-control ui-autocomplete-input" value="" autocomplete="off" required>
                            </div>
                        </div>
...
$(document).ready(function() {
    $(document).on('click', '#pilih', function() {
        ...
        if (id == 1) {
            $('#kode').val("<?= kodeSubKlasifikasi(); ?>");
        } else if (id == 2) {
            $('#kode').val("<?= kodeSubKlasifikasi2(); ?>");
        } else if (id == 3) {
            $('#kode').val("<?= kodeSubKlasifikasi3(); ?>");
        } else if (id == 4) {
            $('#kode').val("<?= kodeSubKlasifikasi4(); ?>");
        } else if (id == 5) {
            $('#kode').val("<?= kodeSubKlasifikasi5(); ?>");
        } else if (id == 6) {
            $('#kode').val("<?= kodeSubKlasifikasi6(); ?>");
        } else if (id == 7) {
            $('#kode').val("<?= kodeSubKlasifikasi7(); ?>");
        } else if (id == 8) {
            $('#kode').val("<?= kodeSubKlasifikasi8(); ?>");
        } else if (id == 9) {
            $('#kode').val("<?= kodeSubKlasifikasi9(); ?>");
        } else if (id == 10) {
            $('#kode').val("<?= kodeSubKlasifikasi10(); ?>");
        } else if (id == 11) {
            $('#kode').val("<?= kodeSubKlasifikasi11(); ?>");
        } else if (id == 12) {
            $('#kode').val("<?= kodeSubKlasifikasi12(); ?>");
        } else if (id == 13) {
            $('#kode').val("<?= kodeSubKlasifikasi13(); ?>");
        } else if (id == 14) {
            $('#kode').val("<?= kodeSubKlasifikasi14(); ?>");
        } else if (id == 15) {
            $('#kode').val("<?= kodeSubKlasifikasi15(); ?>");
        } else if (id == 16) {
            $('#kode').val("<?= kodeSubKlasifikasi16(); ?>");
        } else if (id == 17) {
            $('#kode').val("<?= kodeSubKlasifikasi17(); ?>");
        } else if (id == 18) {
            $('#kode').val("<?= kodeSubKlasifikasi18(); ?>");
        } else if (id == 19) {
            $('#kode').val("<?= kodeSubKlasifikasi19(); ?>");
        } else if (id == 20) {
            $('#kode').val("<?= kodeSubKlasifikasi20(); ?>");
        } else {}
