        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <?php
                        $user = $this->db->query("SELECT nama_ruangan as nama FROM tbl_ruangan Where id_ruangan = '$kode_ruangan'");

                        foreach ($user->result() as $users) {
                        ?>
                        <h2>
                            Data Ruangan <b><?= $users->nama ?></b>
                        </h2>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-xs btn-warning"
                                                href="<?= base_url() ?>admin/updatebarang/<?= $bgn['id_barang']; ?>"><i
                                                    class="material-icons">edit</i> <span class="icon-name">Edit</span>
                                            </a>

                                            <a class="btn btn-xs btn-danger waves-effect tombol-hapus"
                                                data-type="success"
                                                href="<?= base_url() ?>admin/fungsi_delete_barang/<?= $bgn['id_barang']; ?>"><i
                                                    class="material-icons">delete</i><span
                                                    class="fa fa-trash">Hapus</span>
                                            </a>
                                            <a class="btn btn-xs btn-info"
                                                href="<?= base_url() ?>admin/cetak_kode_barang/<?= $bgn['id_barang']; ?>"><i
                                                    class="material-icons">print</i> <span
                                                    class="icon-name">Cetak</span>
                                            </a>
                                        </td>
