...
$(document).ready(function() {
    $(document).on('click', '#pilih', function() {
        ...
        $('#golongan_id').val(id);
        if (id == 1) {
            $('#kode').val("<?= kodeKlasifikasi(); ?>");
        } else if (id == 2) {
            $('#kode').val("<?= kodeKlasifikasi2(); ?>");
        } else if (id == 3) {
            $('#kode').val("<?= kodeKlasifikasi3(); ?>");
        } else if (id == 4) {
            $('#kode').val("<?= kodeKlasifikasi4(); ?>");
        } else if (id == 5) {
            $('#kode').val("<?= kodeKlasifikasi5(); ?>");
        } else if (id == 6) {
            $('#kode').val("<?= kodeKlasifikasi6(); ?>");
        } else if (id == 7) {
            $('#kode').val("<?= kodeKlasifikasi7(); ?>");
        } else if (id == 8) {
            $('#kode').val("<?= kodeKlasifikasi8(); ?>");
        } else if (id == 9) {
            $('#kode').val("<?= kodeKlasifikasi9(); ?>");
        } else {}
