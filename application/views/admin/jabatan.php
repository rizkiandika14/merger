                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $u['nama_ketua']; ?></td>
                                            <td><?= $u['nik'] ?></td>
                                            <td> <img src="<?= base_url('assets/img/ttd_ketua/') . $u['ttd']; ?>"
                                                    width="30" height="30" alt="Image"></td>
                                            <td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="body">
                            <form class="form-horizontal">
                                ...
                                <label for="Nama Ketua">NIK :</label>
                                <div class="form-group">
                                    <div class="form-line">
                                ...
                                <div class="form-group">
                                    <img src="<?= base_url('assets/img/ttd_ketua/') . $u['ttd']; ?>" width="50"
