    ...
    <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table
                                    class="table table-bordered table-striped table-hover dataTable js-exportable-barang"
                                    id="example">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><a
                                                    href="<?= base_url() ?>admin/jenis_barang_isi/<?= $jnsb['id_jenis_barang']; ?>"><?= $jnsb['jenis_barang']; ?></a>
                                            </td>
                                            <td>
                                                <div class="btn btn-sm btn-warning">
                                                    <div class="demo-google-material-icon" data-toggle="modal"
                                                        data-target="#editModal<?= $jnsb['id_jenis_barang']; ?>"> <span
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Edit Jenis Barang</h4>
                    </div>
        ...
        <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Add Jenis Barang</h4>
                    </div>
