                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select name="satuan" id="satuan" class="form-control" required>
                                    <option value="<?= $aset['satuan_barang']; ?>"><?= $aset['satuan_barang']; ?>
                                    </option>
                                    <?php
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <input type="hidden" id="kode_asal_barang" name="kode_asal_barang"
                                    value="<?= $aset['kode_asal_barang']; ?>">
                            </div>
                        </div>
