<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            ...
            <div class="sukses" data-sukses="<?= $this->session->flashdata('pesan') ?>">
                <?php if ($this->session->flashdata('pesan')) { ?>

                <?php } ?>
            </div>
            <div class="setuju" data-setuju="<?= $this->session->flashdata('alert') ?>">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <form
                                action="<?= base_url('export/cetak_pengajuan'); ?>/<?= $tanggal ?>/<?= $user_id ?>/<?= $minggu ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-danger tombol-tolak"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="number" id="realisasi" name="realisasi"
                                                    class="form-control" value="<?= $brg['jumlah']; ?>">
                                            </div>
                                        </div>
                                    </div>
