            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <form
                            action="<?= base_url('export/cetak_berita_acara'); ?>/<?= $tanggal ?>/<?= $user_id ?>/<?= $minggu ?>"
                            method="post" enctype="multipart/form-data">

                            <h5>No Surat BA : <?= kodeSuratBA(); ?></h5>
                            <input type="hidden" id="no_surat" name="no_surat" value="<?= kodeSuratBA(); ?>"
