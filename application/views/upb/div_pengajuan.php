            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <form
                            action="<?= base_url('export/cetak_pengajuan_upb'); ?>/<?= $tanggal ?>/<?= $user_id ?>/<?= $minggu ?>"
...
<div class="modal fade" id="editprModal<?= $brg['id']; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">PROSES PENGAJUAN</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="body">
                    <form class="form-horizontal">
                        ...
                        <div class="modal-footer">
                            <button data-type="success" type="submit" class="btn btn-link waves-effect">PROSES</button>
            ...
            <div class="modal-body">
                ...
                <div class="body">
                    <form class="form-horizontal">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-link waves-effect">TOLAK</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                            <?php echo form_close() ?>
