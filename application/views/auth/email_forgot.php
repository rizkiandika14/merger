...
<head>
    ...
    <title>New email template 2023-07-05</title>
    <!--[if (mso 16)]>
    <style type="text/css">
...
<body style="width:100%;height:100%;padding:0;Margin:0">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://qixlqj.stripocdn.email/content/guids/CABINET_1799720e392ab1c1a525b97fc0ac2e0d309fb7cca9d36c60256b865e4bfc22e6/images/logoamikom.png"
                                                                        alt="Confirm email"
                                                                        style="display:block;font-size:18px;border:0;outline:none;text-decoration:none;border-radius:0"
                                                                        width="100" title="Confirm email"></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        recently forgot your password.<br><br>Click this
                                                                        button below.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" 
                style="height:56px; v-text-anchor:middle; width:520px" arcsize="50%" stroke="f"  fillcolor="#f33630">
...
<![endif]-->
                                                                    ...
                                                                    <!-- --><span class="es-button-border msohide"
                                                                        style="border-style:solid;border-color:#2CB543;background:#f33630;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            href="<?= $link; ?>"
                                                                            class="es-button msohide" target="_blank"
                                                                            style="mso-line-height-rule: exactly; color: #FFFFFF; font-size: 22px; padding: 15px 20px 15px 20px; display: block; background: #f33630; border-radius: 30px; font-family: Imprima, Arial, sans-serif; font-weight: bold; font-style: normal; line-height: 26px; width: auto; text-align: center; letter-spacing: 0; mso-padding-alt: 0; mso-border-alt: 10px solid #f33630; mso-hide: all; padding-left: 5px; padding-right: 5px; mso-style-priority: 100; text-decoration: none;">Reset
                                                                            Password</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;letter-spacing:0;color:#2D3142;font-size:18px">
                                                                        Thanks,<br><br>BAK Universitas Amikom
                                                                        Purwokerto&nbsp;</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;letter-spacing:0;color:#2D3142;font-size:18px">
                                                                        &nbsp;</p>
