                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;  ">
                                                <?php if ($divp['status'] == 'disetujui' && $divp['validasi'] == 'belum diterima') : ?>
                                                <a class="btn btn-sm btn-info tombol-validasi"
                                                    href="<?= base_url() ?>divisi/divisi_diterima/<?= $divp['id']; ?>"><i
                                                        class="material-icons">done</i></a>
                                                <?php elseif ($divp['status'] == 'Disetujui UPB' && $divp['validasi'] == 'belum diterima') : ?>
                                                <a class="btn btn-sm btn-info tombol-validasi"
                                                    href="<?= base_url() ?>divisi/divisi_diterima/<?= $divp['id']; ?>"><i
                                                        class="material-icons">done</i></a>
                                                <?php else : ?>
