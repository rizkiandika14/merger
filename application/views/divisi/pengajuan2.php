                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form method="post" action="<?= base_url('divisi/add_temp2'); ?>">
                            <input type="text" data-toggle="modal" data-target="#defaultModal" name="nama_brg"
                                id="nama_brg" placeholder="Nama Barang" class="form-control ui-autocomplete-input"
                                value="" autocomplete="on" readonly required>
                            <br>
