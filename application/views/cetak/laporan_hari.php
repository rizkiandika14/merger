...
<body>
    ...
    <div class="kiri" style="margin: 0 auto;">
        ...
        <p><img src="<?= base_url('assets/img/ttd/') . $users->foto_ttd; ?>" style="width:140px;height:100px" /></p>
        <b>
    ...
    <div class="kanan" style="margin: 0 auto;">
        ...
        <p></p>
        <p> </p>
        <p><img src="<?= base_url('assets/img/ttd_ketua/') . $users->ttd; ?>" style="width:140px;height:100px" /></p>
        <b>
            <p><?php echo $users->nama_ketua ?></p>
            <p>NIK : <?php echo $users->nik ?><br></p>
        </b>
        <br>
        <br>
