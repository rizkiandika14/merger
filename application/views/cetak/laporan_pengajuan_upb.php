    ...
    <div class="isi" style="margin: 0 auto;">
        ...
        <table class="tabel2">
            ...
            <tfoot>
                ...
                $totalp = $this->db->query("SELECT sum(total) as totalp FROM pengajuan Where minggu = $minggu AND waktu_pengajuan = '$tanggal' AND user_id = '$user_id' AND status = 'diusulkan'");
