    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Pengadaan Barang | UPB</a>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('upb/vendor') ?>">Data Vendor</a>
                            </li> 
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('upb/arsipdokumen') ?>">Arsip Dokumen UPB</a>
                            </li>
                        </ul>
