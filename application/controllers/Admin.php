...
class Admin extends CI_Controller
{
    ...
    public function rekapBarang()
    {
        ...
        $data['totalp'] = $this->pengajuan_model->getJumlahAllBarang();
        $this->load->view('templates/header');
        $this->load->view('templates/admin_sidebar');
    ...
    public function tambah_asal_barang()
    {
        ...
        $this->session->set_flashdata('pesan', 'Data Added!');
    ...
    public function fungsi_delete_jenis_barang($id)
    {
        ...
        $this->session->set_flashdata('pesan', 'Delete Success!');
    ...
    public function fungsi_edit_klasifikasi()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-info" role="alert">Data Klasifikasi Edited!</div>');
    ...
    public function fungsi_delete_lahan($id_lahan)
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Data Lahan Deleted!</div>');
    ...
    public function fungsi_edit_bangunan()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-info" role="alert">Data Bangunan Edited!</div>');
        Redirect(base_url('admin/bangunan'));
    }
    ...
    public function fungsi_edit_ruangan()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-info" role="alert">Data Ruangan Edited!</div>');
        Redirect(base_url('admin/ruangan'));
    }
    ...
    {
        $this->load->model('Upbmaster_model', 'upbmaster_model');
        $data['bangunan'] = $this->upbmaster_model->ambil_kode_bangunan($kode_bangunan);
        $data['kode_bangunan'] = $kode_bangunan;
        $this->load->view('templates/header');
        $this->load->view('templates/admin_sidebar');
    ...
    public function jenis_barang_isi($id_jenis_barang)
    {
        $this->load->model('Upbmaster_model', 'upbmaster_model');
        $data['id_jenis'] = $this->upbmaster_model->ambil_id_jenis_barang($id_jenis_barang);
        $data['id_jenis_barang'] = $id_jenis_barang;
        $this->load->view('templates/header');
        $this->load->view('templates/admin_sidebar');
        $this->load->view('admin/jenis_barang_isi', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function fungsi_edit_jabatan()
    {
        ...
        $this->session->set_flashdata('pesan', 'Success Edited!');
        // $this->session->set_flashdata('message', '<div class="alert alert-info" role="alert">Data Jabatan Edited!</div>');
