...
class User extends CI_Controller
{
    ...
    private function _sendEmail($id, $type)
    {
        ...
        $data = array('name' => 'BAK Amikom Purwokerto');
        ...
        if ($type == 'active') {
            ...
            $message = $this->load->view('auth/email_aktif', $data, TRUE);
            $this->email->message($message);
        } elseif ($type == 'nonactive') {
            $this->email->subject('Account Non Activated!');
            $this->email->message('Your account has been nonactivated <br>Please contact Admin to Activated again!');
        }
