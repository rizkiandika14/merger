...
class Upbmaster_model extends CI_Model
{
    ...
    {
        $query =  "SELECT tbl_barang.*, asal_barang.nama_asal_barang, asal_barang.id_asal_barang, asal_barang.kode_asal_barang
            FROM tbl_barang
            left join asal_barang ON asal_barang.id_asal_barang = tbl_barang.id_asal_barang
            ";
        return $this->db->query($query)->result_array();
    }
    ...
    {
        $query = "SELECT tbl_barang.*, tbl_ruangan.nama_ruangan, jenis_barang.jenis_barang, asal_barang.nama_asal_barang, asal_barang.kode_asal_barang, subklasifikasi.keterangan_subklas
        FROM tbl_barang
    ...
    public function ambil_kode_ruangan_isi($kode_ruangan)
    {
        ...
        tbl_ruangan.id_ruangan = $kode_ruangan
        ";
        return $this->db->query($query)->result_array();
    }
    ...
    public function ambil_id_jenis_barang($id_jenis_barang)
    {
        $query = "SELECT tbl_barang.*, jenis_barang.id_jenis_barang, jenis_barang.jenis_barang
        FROM tbl_barang
        left join jenis_barang ON tbl_barang.id_jenis_barang = jenis_barang.id_jenis_barang where
