...
class Pengajuan_model extends CI_Model
{
    ...
    {
        $query = "SELECT barang.nama_brg, pengajuan.waktu_pengajuan, pengajuan.id, pengajuan.realisasi , pengajuan.jumlah, pengajuan.satuan, pengajuan.harga, pengajuan.total, pengajuan.status, pengajuan.waktu_validasi, pengajuan.validasi, pengajuan.user_id, user.divisi
        FROM pengajuan
       
       left JOIN barang ON pengajuan.barang_id=barang.id
       left JOIN user ON pengajuan.user_id = user.id
        where status != 'proses'
                    ";
    ...
    {
        $query = "SELECT barang.nama_brg, pengajuan.waktu_pengajuan, pengajuan.id, pengajuan.realisasi , pengajuan.jumlah, pengajuan.satuan, pengajuan.harga, pengajuan.total, pengajuan.status, pengajuan.waktu_validasi, pengajuan.validasi, pengajuan.user_id, pengajuan.divisi
        FROM pengajuan
    ...
    public function getAllBarang()
    {
        ...
        FROM pengajuan
        LEFT JOIN barang ON pengajuan.barang_id=barang.id
        where status BETWEEN 'disetujui' AND 'Disetujui UPB'
                    ";
        return $this->db->query($query)->result_array();
    }
    ...
    public function getDateBarang($tgla, $tglb, $nama_brg, $divisi)
    {
        ...
        FROM pengajuan
        INNER JOIN barang ON pengajuan.barang_id=barang.id
        where waktu_pengajuan BETWEEN '$tgla' AND '$tglb' AND nama_brg = '$nama_brg' AND divisi = '$divisi' AND status BETWEEN 'disetujui' AND 'Disetujui UPB'
                    ";
        return $this->db->query($query)->result_array();
    }
    ...
    public function getjumlahAllBarang()
    {
        $query = "SELECT sum(pengajuan.jumlah) as totalp, barang.nama_brg, pengajuan.divisi, pengajuan.waktu_pengajuan, pengajuan.id, pengajuan.realisasi , pengajuan.jumlah, pengajuan.satuan, pengajuan.harga, pengajuan.total, pengajuan.status, pengajuan.waktu_validasi, pengajuan.validasi, pengajuan.user_id
        FROM pengajuan
        LEFT JOIN barang ON pengajuan.barang_id=barang.id
